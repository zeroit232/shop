  ...
  <div class="product-info">
    ...
    <div class="right">
      ...
      <div class="price"><?php echo $text_price; ?>
        <?php if (!$special) { ?>
        <span class="price-first"><?php echo $price; ?></span>
        <?php } else { ?>
      ...
      <div class="cart">
		...
		<div class="action">
          ...
          <span class="button_pink"><input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="button" /></span>
          <a class="compare" onclick="boss_addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a><br/>
		  <a class="wishlist" onclick="boss_addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a>
        </div>
      </div>
